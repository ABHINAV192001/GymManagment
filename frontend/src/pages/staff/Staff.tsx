...
export const StaffManagement: React.FC = () => {
  ...
  const isSelf = useCallback((s: Staff | null | undefined): boolean => {
    if (!s) return false;
    if (currentUserId && s.id === currentUserId) return true;
    if (currentUserEmail && s.email && s.email.toLowerCase().trim() === currentUserEmail) return true;
    return false;
  ...
  const filteredStaff = staff.filter((s) => {
    const phoneVal = s.phone || (s as any).phoneNumber || '';
    ...
    const matchesBranch = selectedBranchId === 'ALL' 
      ...
      || (Array.isArray((s as any).accessibleBranchIds) && (s as any).accessibleBranchIds.includes(selectedBranchId));
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4" aria-label="Staff payroll metrics">
        <div className="p-3 sm:p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[11px] font-bold text-zinc-500 uppercase truncate">Active Staff</p>
            <h4 className="text-base sm:text-xl font-black text-zinc-900 dark:text-zinc-50 mt-0.5 truncate">{totalActiveStaff} Members</h4>
          </div>
          <div className="p-2 sm:p-2.5 rounded-xl bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 shrink-0">
        ...
        <div className="p-3 sm:p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[11px] font-bold text-zinc-500 uppercase truncate">Monthly Payroll</p>
            <h4 className="text-base sm:text-xl font-black text-zinc-900 dark:text-zinc-50 mt-0.5 truncate">₹{totalMonthlyPayroll.toLocaleString()}</h4>
          </div>
          <div className="p-2 sm:p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 shrink-0">
        ...
        <div className="p-3 sm:p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[11px] font-bold text-zinc-500 uppercase truncate">Average Base</p>
            <h4 className="text-base sm:text-xl font-black text-zinc-900 dark:text-zinc-50 mt-0.5 truncate">₹{avgBaseSalary.toLocaleString()}</h4>
          </div>
          <div className="p-2 sm:p-2.5 rounded-xl bg-purple-50 dark:bg-purple-950/30 text-purple-600 dark:text-purple-400 shrink-0">
        ...
        <div className="p-3 sm:p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-sm flex items-center justify-between">
          <div className="min-w-0">
            <p className="text-[10px] sm:text-[11px] font-bold text-zinc-500 uppercase truncate">Trainers</p>
            <h4 className="text-base sm:text-xl font-black text-zinc-900 dark:text-zinc-50 mt-0.5 truncate">{totalTrainersCount} Active</h4>
          </div>
          <div className="p-2 sm:p-2.5 rounded-xl bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 shrink-0">
      ...
      <div className="flex flex-col sm:flex-row gap-3 p-3.5 sm:p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 items-stretch sm:items-center justify-between shadow-sm">
        <div className="flex flex-1 gap-2.5 w-full items-center">
          ...
          <select
            ...
            className="text-xs px-3 py-2.5 border border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 rounded-xl text-zinc-900 dark:text-zinc-100 font-medium shrink-0"
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="flex-1 sm:flex-none px-3.5 py-2.5 bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 border border-zinc-200 dark:border-zinc-800"
            title="Configure Staff & Payroll Cut-off Settings"
          >
            <Settings className="w-4 h-4 text-zinc-500" /> <span>Settings</span>
          </button>

          {(canCreate('staff') || canCreate('users')) && (
            <button
              onClick={() => setIsFormOpen(true)}
              className="flex-1 sm:flex-none px-4 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold transition flex items-center justify-center gap-1.5 shadow-sm shadow-blue-500/20 active:scale-[0.98] shrink-0"
            >
              <UserPlus className="w-4 h-4" /> <span>Onboard Staff</span>
            </button>
          )}
        </div>
      </div>
              ...
              >
                <div>
                    ...
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {isSelf(s) && (
                            <span className="text-[10px] font-extrabold px-1.5 py-0.2 rounded bg-blue-100 dark:bg-blue-950 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                              You
                            </span>
                          )}
                  ...
                  <div className="space-y-2 text-xs text-zinc-600 dark:text-zinc-400 pt-3 border-t border-zinc-100 dark:border-zinc-900">
                    ...
                    <p className="flex items-center gap-2 font-mono"><Phone className="w-3.5 h-3.5 text-zinc-400 shrink-0" /> {s.phone || (s as any).phoneNumber || '—'}</p>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-zinc-100 dark:border-zinc-900 mt-4 flex items-center justify-between gap-2" onClick={(e) => e.stopPropagation()}>
                  ...
                  <div className="flex items-center gap-1.5">
                    {(canEdit('staff') || canEdit('users')) && !isSelf(s) && (
                      <button
                    ...
                    {(canEdit('accounts') || canEdit('staff') || canCreate('accounts')) && (
                      <button
                    ...
                    {(canView('accounts') || canView('staff') || isSelf(s)) && (
                      <button
                        onClick={() => setPayslipStaff(s)}
