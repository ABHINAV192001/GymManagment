...
-- Covers: b2222222 presets (Full Body, Bro Split, Arms, Powerlifting 5x5,
...
-- ============================================================
-- b2222222 PRESET PROGRAMS
-- ============================================================

-- 1. 3-Day Full Body Frequency Hypertrophy Split (b2222222-0000-0000-0000-000000000008)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0081001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000008', 'Day 1 - Monday',    'Full Body A (Squat Focus)',        'Barbell Back Squat, Barbell Bench Press, Barbell Row, Overhead Press, Romanian Deadlift, Dips, Bicep Curls',                     1),
  ('e0081001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000008', 'Day 2 - Wednesday', 'Full Body B (Hinge Focus)',        'Deadlift, Incline Dumbbell Press, Weighted Pull-Ups, Goblet Squat, Cable Flyes, Tricep Pushdowns, Hammer Curls',                 2),
  ('e0081001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000008', 'Day 3 - Friday',    'Full Body C (Frequency Volume)',   'Bulgarian Split Squat, Barbell Bench Press, Lat Pulldowns, Leg Press, Arnold Press, Skull Crushers, Preacher Curls',             3)
ON CONFLICT (id) DO NOTHING;

-- 2. 5-Day Classic Bodypart Bro Split (b2222222-0000-0000-0000-000000000004)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0041001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000004', 'Day 1 - Monday',    'Chest Day',                        'Flat Barbell Bench Press, Incline Dumbbell Press, Decline Barbell Press, Cable Chest Flyes, Pec Deck Butterfly, Weighted Dips',                                   1),
  ('e0041001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000004', 'Day 2 - Tuesday',   'Back Day',                         'Deadlift, Wide-Grip Pull-Ups, Barbell Bent-Over Row, T-Bar Row, Seated Cable Row, Single-Arm Dumbbell Row',                                                       2),
  ('e0041001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000004', 'Day 3 - Wednesday', 'Shoulders Day',                    'Standing Military Press, Dumbbell Lateral Raises, Barbell Upright Row, Rear Delt Fly, Arnold Press, Shrugs',                                                       3),
  ('e0041001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000004', 'Day 4 - Thursday',  'Arms Day (Biceps & Triceps)',       'Barbell Bicep Curl, Incline Dumbbell Curl, Hammer Curls, Preacher Curl, Triceps Pushdowns, Skull Crushers, Overhead Triceps Extension',                           4),
  ('e0041001-0000-0000-0000-000000000005', 'b2222222-0000-0000-0000-000000000004', 'Day 5 - Friday',    'Legs Day',                         'Barbell Back Squat, Romanian Deadlift, Leg Press, Leg Extensions, Lying Leg Curls, Standing Calf Raises, Seated Calf Raises',                                    5)
ON CONFLICT (id) DO NOTHING;

-- 3. 5-Day Upper / Lower / Arms Specialization (b2222222-0000-0000-0000-000000000010)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0101001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000010', 'Day 1 - Monday',    'Upper Body Push + Triceps',        'Bench Press, Overhead Press, Cable Flyes, Triceps Pushdowns, Skull Crushers, Overhead Triceps Extension, Dips',                                                    1),
  ('e0101001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000010', 'Day 2 - Tuesday',   'Lower Body Power',                 'Barbell Squat, Romanian Deadlift, Leg Press, Leg Extensions, Seated Leg Curls, Calf Raises',                                                                       2),
  ('e0101001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000010', 'Day 3 - Thursday',  'Upper Body Pull + Biceps',         'Deadlift, Pull-Ups, T-Bar Row, Cable Rows, Barbell Curl, Incline Dumbbell Curl, Hammer Curls, Preacher Curl',                                                     3),
  ('e0101001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000010', 'Day 4 - Friday',    'Arms Specialization Day',          'Close-Grip Bench Press, Skull Crushers, Rope Pushdowns, Barbell Curl, Concentration Curl, Reverse Curl, Wrist Curls',                                            4),
  ('e0101001-0000-0000-0000-000000000005', 'b2222222-0000-0000-0000-000000000010', 'Day 5 - Saturday',  'Shoulders & Rear Delts',           'Military Press, Arnold Press, Dumbbell Lateral Raises, Face Pulls, Rear Delt Flyes, Shrugs',                                                                      5)
ON CONFLICT (id) DO NOTHING;

-- 4. 5x5 Heavy Powerlifting Peak Strength Split (b2222222-0000-0000-0000-000000000006)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0061001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000006', 'Day 1 - Monday',      'Heavy Squat & Press (5x5 A)',       'Barbell Back Squat 5x5, Barbell Bench Press 5x5, Barbell Row 5x5',              1),
  ('e0061001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000006', 'Day 2 - Wednesday',   'Heavy Squat & Overhead (5x5 B)',    'Barbell Back Squat 5x5, Overhead Press 5x5, Deadlift 1x5',                     2),
  ('e0061001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000006', 'Day 3 - Friday',      'Heavy Squat & Press (5x5 A)',       'Barbell Back Squat 5x5, Barbell Bench Press 5x5, Barbell Row 5x5',              3),
  ('e0061001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000006', 'Day 4 - Next Monday', 'Heavy Squat & Overhead (5x5 B)',    'Barbell Back Squat 5x5, Overhead Press 5x5, Deadlift 1x5',                     4)
ON CONFLICT (id) DO NOTHING;

-- 5. German Volume Training GVT 10x10 Mass Split (b2222222-0000-0000-0000-000000000007)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0071001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000007', 'Day 1 - Monday',    'Chest & Back 10x10',               'Flat Barbell Bench Press 10x10, Wide-Grip Pull-Ups 10x10, Incline Dumbbell Fly 3x12, Cable Row 3x12',              1),
  ('e0071001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000007', 'Day 2 - Tuesday',   'Legs & Abs 10x10',                 'Barbell Back Squat 10x10, Romanian Deadlift 10x10, Leg Press 3x15, Hanging Leg Raises 3x15',                       2),
  ('e0071001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000007', 'Day 3 - Thursday',  'Arms & Shoulders 10x10',           'Barbell Bicep Curl 10x10, Close-Grip Bench Press 10x10, Lateral Raises 3x15, Overhead Press 3x12',                 3),
  ('e0071001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000007', 'Day 4 - Friday',    'Back & Chest Accessory 10x10',     'Incline Barbell Press 10x10, T-Bar Row 10x10, Pec Deck Fly 3x12, Lat Pulldown 3x12',                               4),
  ('e0071001-0000-0000-0000-000000000005', 'b2222222-0000-0000-0000-000000000007', 'Day 5 - Saturday',  'Legs & Core Accessory 10x10',      'Front Squat 10x10, Leg Curl 10x10, Cable Crunches 3x15, Calf Raises 3x20',                                         5)
ON CONFLICT (id) DO NOTHING;

-- 6. Mike Mentzer Heavy Duty HIT Split (b2222222-0000-0000-0000-000000000009)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0091001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000009', 'Day 1 - Monday',    'Chest & Back (1 All-Out Set)',      'Flat Bench Press 1x failure, Wide-Grip Pull-Ups 1x failure, Pec Deck 1x failure, Deadlift 1x failure',              1),
  ('e0091001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000009', 'Day 2 - Wednesday', 'Legs (1 All-Out Set)',              'Leg Press 1x failure, Leg Extensions 1x failure, Lying Leg Curls 1x failure, Standing Calf Raises 1x failure',     2),
  ('e0091001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000009', 'Day 3 - Friday',    'Shoulders & Arms (1 All-Out Set)', 'Overhead Press 1x failure, Lateral Raises 1x failure, Barbell Curl 1x failure, Skull Crushers 1x failure',          3)
ON CONFLICT (id) DO NOTHING;

-- 7. Functional Athletic Performance & Agility Hybrid Split (b2222222-0000-0000-0000-000000000011)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0111001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000011', 'Day 1 - Monday',    'Lower Body Power & Explosiveness', 'Barbell Squat, Deadlift, Box Jumps, Broad Jumps, Sled Push, Sprint Intervals',                                       1),
  ('e0111001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000011', 'Day 2 - Tuesday',   'Upper Body Push & Core Rotation',  'Push Press, Bench Press, Landmine Press, Cable Wood Chop, Medicine Ball Slam, Pallof Press',                         2),
  ('e0111001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000011', 'Day 3 - Thursday',  'Upper Body Pull & Rotational Core', 'Pull-Ups, Dumbbell Row, Face Pulls, Rotational Cable Row, Battle Ropes, Turkish Get-Up',                            3),
  ('e0111001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000011', 'Day 4 - Friday',    'Full Body Athletic Conditioning',  'Power Clean, Farmers Walk, Kettlebell Swing, Agility Ladder, Plyo Push-Ups, Timed Sprint Repeats',                   4)
ON CONFLICT (id) DO NOTHING;

-- 8. Posterior Chain & Glute Sculpting Split (b2222222-0000-0000-0000-000000000012)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0121001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000012', 'Day 1 - Monday',    'Glutes & Hamstrings Heavy',        'Barbell Hip Thrust, Romanian Deadlift, Sumo Deadlift, Cable Glute Kickback, Lying Leg Curl, Deficit Reverse Lunge',   1),
  ('e0121001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000012', 'Day 2 - Wednesday', 'Quads & Glutes Volume',            'Barbell Back Squat, Leg Press, Bulgarian Split Squat, Curtsy Lunges, Leg Extensions, Abductor Machine',                2),
  ('e0121001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000012', 'Day 3 - Friday',    'Posterior Chain & Core Finish',    'Glute-Ham Raise, Cable Pull-Through, Frog Pumps, Single-Leg RDL, Reverse Hyper-Extensions, Cable Crunches',           3),
  ('e0121001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000012', 'Day 4 - Saturday',  'Glutes & Hamstrings Pump',         'Dumbbell Hip Thrust, Kettlebell Swing, Step-Ups, Nordic Hamstring Curl, Swiss Ball Leg Curl, Hip Abductor Flyes',     4)
ON CONFLICT (id) DO NOTHING;

-- 9. Fat Loss Shred & High-Calorie Burn Split (b2222222-0000-0000-0000-000000000005)
INSERT INTO workout_split_days (id, workout_id, day_label, name, description, display_order) VALUES
  ('e0051001-0000-0000-0000-000000000001', 'b2222222-0000-0000-0000-000000000005', 'Day 1 - Monday',    'Upper Body HIIT Circuit',          'Push-Ups, Dumbbell Rows, Shoulder Press, Lat Pulldown, Bicep Curls, Tricep Pushdowns, Mountain Climbers',              1),
  ('e0051001-0000-0000-0000-000000000002', 'b2222222-0000-0000-0000-000000000005', 'Day 2 - Tuesday',   'Lower Body Metabolic Blast',       'Goblet Squat, Romanian Deadlift, Reverse Lunges, Leg Press, Leg Extensions, Box Jumps, Jump Squats',                  2),
  ('e0051001-0000-0000-0000-000000000003', 'b2222222-0000-0000-0000-000000000005', 'Day 3 - Wednesday', 'Full Body Cardio Resistance',      'Burpees, Kettlebell Swings, Battle Ropes, Jump Rope, Dumbbell Thrusters, Renegade Rows, Plank Holds',                 3),
  ('e0051001-0000-0000-0000-000000000004', 'b2222222-0000-0000-0000-000000000005', 'Day 4 - Thursday',  'Upper Body Strength + Cardio',     'Incline Press, Weighted Pull-Ups, Cable Flyes, Face Pulls, Hammer Curls, Dips, Bike Sprint Intervals',                 4),
  ('e0051001-0000-0000-0000-000000000005', 'b2222222-0000-0000-0000-000000000005', 'Day 5 - Friday',    'Lower Body + Core Shred',          'Hip Thrusts, Sumo Deadlift, Walking Lunges, Calf Raises, Hanging Leg Raises, Cable Crunches, Russian Twists',         5)
ON CONFLICT (id) DO NOTHING;
